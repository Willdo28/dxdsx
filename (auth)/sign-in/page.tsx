...
export default function Page(){
  ...
  async function onSubmit(){
    if('sign-in'==='sign-up') await supabase.auth.signUp({ email });
    if('sign-in'==='sign-in') await supabase.auth.signInWithOtp({ email });
  }
  return <main className="p-8">
    <div className="glass max-w-md mx-auto p-6 rounded-2xl">
      <h1 className="text-2xl capitalize">sign in</h1>
